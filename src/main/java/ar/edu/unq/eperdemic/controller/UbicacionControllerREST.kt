...
class UbicacionControllerREST( private val ubicacionService: UbicacionService ) {
    ...
    fun conectarUbicaciones( @PathVariable nombreUbicacion1: String, @PathVariable nombreUbicacion2: String, @PathVariable tipoCamino: TipoDeCamino) = ubicacionService.conectar(nombreUbicacion1, nombreUbicacion2, tipoCamino.toString())
