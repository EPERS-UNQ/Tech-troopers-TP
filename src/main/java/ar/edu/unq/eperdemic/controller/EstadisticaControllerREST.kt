...
class EstadisticaControllerREST ( private val estadisticaService: EstadisticaService ){
    ...
    fun especiesLideres( @PathVariable direccion: String, @PathVariable pagina: Int, @PathVariable cantPorPagina: Int ) = estadisticaService.lideres(enumValueOf<Direccion>(direccion), pagina, cantPorPagina).map { especie -> especie.aDTO() }
